...
function primusProvider(){function t(t,i){var e=new Primus(this.endpoint,this.options),r={};return e.$on=function(n,i){function r(){var n=arguments;t.$apply(function(){i.apply(null,n)})}return e.on(n,r),function(){e.removeListener(n,r)}},e.$resource=function(o,u){if(u="undefined"==typeof u?n.multiplex:u,r[o])return r[o].promise;r[o]=i.defer();var s=e.resource(o,u);return s.once("ready",function(){r[o].resolve(s),t.$apply()}),r[o].promise},e}var n=this;this.$get=["$rootScope","$q",t],this.setOptions=function(t){return this.options=t,this},this.setEndpoint=function(t){return this.endpoint=t,this},this.setDefaultMultiplex=function(t){return this.multiplex=t,this}}angular.module("primus",[]).provider("primus",primusProvider);
